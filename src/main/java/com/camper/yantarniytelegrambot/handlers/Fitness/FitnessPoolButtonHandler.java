...
@Component
public class FitnessPoolButtonHandler implements BotButtonHandler {
    ...
    public List<PartialBotApiMethod<?>> handle(String chatId, CallbackQuery query) {
        ...
        if (coaches != null && !coaches.isEmpty()) {
            ...
            if (selectedCoach.getImage() != null) {
                ...
                builder.replyMarkup(getPoolCoachesMarkup(coaches.size()));
                ...
                sendMessage.setReplyMarkup(getPoolCoachesMarkup(coaches.size()));
    ...
    public List<PartialBotApiMethod<?>> nextCoach(String chatId, CallbackQuery query) {
        ...
        return new ArrayList<>(Utils.scrollMenuItem(chatId
                , messageId
                , query
                , getPoolCoachesMarkup(coaches.size())
