...
@Component
public class SpaCosmetologyButtonHandler implements BotButtonHandler {
    ...
    public List<PartialBotApiMethod<?>> handle(String chatId, CallbackQuery query) {
        ...
        if (specialists != null && !specialists.isEmpty()) {
            ...
            if (selectedCoach.getImage() != null) {
                ...
                builder.replyMarkup(getCosmetologySpecialistsMarkup(specialists.size()));
                ...
                sendMessage.setReplyMarkup(getCosmetologySpecialistsMarkup(specialists.size()));
    ...
    public List<PartialBotApiMethod<?>> nextSpecialist(String chatId, CallbackQuery query) {
        ...
        return new ArrayList<>(Utils.scrollMenuItem(chatId
                , messageId
                , query
                , getCosmetologySpecialistsMarkup(specialists.size())
    ...
    private InlineKeyboardMarkup getCosmetologySpecialistsMarkup(int numberOfSpecialists) {
    ...
    public void setEmployeeTypeService(EmployeeTypeService employeeTypeService) {
        this.employeeType = employeeTypeService.findEmployeeTypeByType("COSMETOLOGY_MASTER");
    }
}
